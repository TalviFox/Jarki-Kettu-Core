...
If you've found a critical bug in the core logic or a scenario where the system fails to fail gracefully, please submit an Issue! 

When submitting an Issue, please include:
- A clear description of the problem.
- What you expected to happen vs what actually happened.
- Log excerpts or traces if available.

## ✨ Add-on Modules and Forks

Because the Core is locked down against feature creep, the best way to expand Järki Kettu is through external modules. If you build a cool standalone module that hooks into the Core's sensors without disrupting its fundamental state machine, feel free to share it!
